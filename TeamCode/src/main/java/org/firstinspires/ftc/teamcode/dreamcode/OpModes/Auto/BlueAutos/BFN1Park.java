...
@Autonomous
public class BFN1Park extends Robot {

    int pathStep = 0;
    ElapsedTime timer = new ElapsedTime();
    double setPoint = 32, tolerance = 1, kp = 0.5, kv = 1/Motors.GoBILDA_435.getSurfaceVelocity(2), ka = 0;
    ...
    public void loop() {
        ...
        if (pathStep == 0) {
            ...
            if (super.getEstimator().getA() > -Math.PI/2.8) {
